const { dateFilter } = require('@/domain/utils/filterArrayByDateUtils')

const ObjTrainingOrTalks = {
  res: [
    {
      location: 'Singapour',
      eventType: 'Meetup',
...
describe('date filter', () => {
  it('should return only talk between 19/01/2021 and 25/012021', () => {
    const result = dateFilter(ObjTrainingOrTalks, '19/01/2021', '25/01/2021')
    expect(result).toMatchSnapshot()
  })
  it('should return an array with a length of 2', () => {
    const result = dateFilter(ObjTrainingOrTalks, '19/01/2021', '24/01/2021')
    expect(result.res.length).toBe(4)
  })
})
